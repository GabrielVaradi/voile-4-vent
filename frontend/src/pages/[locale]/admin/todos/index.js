...
const Index = () => {
    ...
    return (
        <>
            <Head>
                <title> Voile 4 vents admin todos page </title>
                <meta
                    name="description"
                    content="For admins, add any todos you have to complete for the voile 4 vents sailing school"
                />
            </Head>
...
const getStaticProps = makeStaticProps(['todos', 'navigation', 'footer'])
