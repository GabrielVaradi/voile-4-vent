    ...
    private function createCourses(): void
    {
        $initiation = Course::query()
            ->create([
                ...
                'description_en' => 'Learn to be a good crew member in complete safety on a sailboat. This course covers the basics of sailing and will allow you to discover if you are ready for your next adventure!',
                'description_fr' => 'Apprendre à être un bon équipier en toute sécurité sur un voilier. Ce cours couvre les rudiments de la voile et vous permettra de découvrir si vous êtes prêt pour votre prochaine aventure!',
        ...
        $basicSkipper = Course::query()
            ->create([
                ...
                'description_fr' => "Pour ceux qui débutent ou possèdent un peu d’expérience de la voile. Le but du cours : acquérir les compétences nécessaires pour pouvoir naviguer en toute sécurité, à titre de chef de bord ou d’équipier, sur un voilier de 6 à 10 mètres.
